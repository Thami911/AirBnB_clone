#!/usr/bin/python3
"""Describes unittests for the console.
Unittest classes:
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Testing prompting for Unittest with HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Testing help messages for Unittest with HBNB command interpreter."""

    def test_help_quit(self):
        mess_h = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(mess_h, output.getvalue().strip())

    def test_help_create(self):
        mess_h = ("Usage: create <class>\n        "
    ...
    def test_help_EOF(self):
        mess_h = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(mess_h, output.getvalue().strip())

    def test_help_show(self):
        mess_h = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
    ...
    def test_help_destroy(self):
        mess_h = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
    ...
    def test_help_all(self):
        mess_h = ("Usage: all or all <class> or <class>.all()\n        "
    ...
    def test_help_count(self):
        mess_h = ("Usage: count <class> or <class>.count()\n        "
    ...
    def test_help_update(self):
        mess_h = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
    ...
    def test_help(self):
        mess_h = ("Documented commands (type help <topic>):\n"
             "========================================\n"
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Testing exiting for Unittest with HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Testing create from the HBNB command interpreter Unittest."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Testing show from the Unittest with HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Testing destroy from the Unittest with HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Testing all of the HBNB command interpreter Unittest."""
